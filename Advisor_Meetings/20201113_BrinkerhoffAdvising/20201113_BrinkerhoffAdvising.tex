...
\usepackage[backend=biber,
		...
		natbib,
		url=false]{biblatex}
\addbibresource{link.bib}	%	Use when on Laptop
...
\begin{table}[!h]
\centering
\caption{Summary of OS and NegShift accoriding to \citet{christensenInterfacesNegationSyntax2005}\\ty (KEY: + = obligatory, - = blocked, \% = optional, § = optional and `non-parallel’).}
\label{tab:OSNEGS}
