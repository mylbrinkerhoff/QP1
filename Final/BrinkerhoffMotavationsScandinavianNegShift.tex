...
In addition to presenting facts about NegShift, I propose that its solution lies in \posscitet{zeijlstraSyntacticallyComplexStatus2011} account of the compositional nature of NIs with the addition of specific prosodic restrictions that exist for the \emph{Mittelfeld}. 
...
%------------------------------------
\subsection{Confound} \label{sec:Confound}
%------------------------------------
