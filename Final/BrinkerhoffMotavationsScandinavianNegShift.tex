...
\citet{iatridouNegativeDPsAMovement2011,zeijlstraSyntacticallyComplexStatus2011} show that in NIs exhibit split-scope where negation has wide scope while the indefinite has narrow scope. This is seen when there are modal auxiliaries present the negation scopes higher than the modals while the indefinite scopes lower than the modals. We can see this in the following example from \citet{iatridouNegativeDPsAMovement2011}. 
...
Following \posscitet{chomskyMinimalistProgram2015} theory of copy-movement and \posscitet{zeijlstraSyntacticallyComplexStatus2011} theoy, we would assume that the NI DP would be fully copied from its base-position and merged into NegP.
...
This is further evidence that the LMC is an active constraint in these languages. 
