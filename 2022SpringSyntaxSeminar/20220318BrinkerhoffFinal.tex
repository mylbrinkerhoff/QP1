...
Based on these patterns in shifting, I argue that they are subject to an economy of representations. Specifically, this economy is based on the size of the resulting prosodic structure with the largest element being allowed to shift is a maximal prosodic word and the smallest being a pronoun which corresponds to a prosodic word or prosodic clitic, depending on the prosodic strength of the pronoun. This results in a similar three-way split as the pronouns in \posscitet{cardinalettiTypologyStructuralDeficiency1999} account. 
